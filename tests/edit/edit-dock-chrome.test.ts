...
describe('global edit control bar', () => {
  it('keeps pager and available element actions in one persistent bar', () => {
    ...
    // The 阵容 (roster) entry is hidden by the course-page redesign for now —
    // the bar must not render it.
    expect(html).not.toContain('data-testid="edit-dock-roster"');
